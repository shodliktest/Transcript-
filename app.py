        ...
        if st.button("🚀 TAHLILNI BOSHLASH"):
            if not client:
                ...
                try:
                    ...
                    # 6. PLAYER HTML (Avto-Skroll bilan)
                    ...
                    # SAHIFANI ALMASHTIRISH (Upload yo'qoladi)
